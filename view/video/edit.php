<div class="col-md-10 justify-content-center text-center">
    ...
    <div class="col-md-8 col-md-offset-2 text-center">
        <form enctype="multipart/form-data" method="POST" action="index.php?page=edit-video" id="edit-video-form" onsubmit="return submitEditVideo(this)">
            ...
            <div class="form-group">
                <input type="text" name="title" id="title" value="<?= htmlentities($params['title']); ?>" onmousemove="validateTitle()"  placeholder="Video Title" class="form-control">
                <div id="title-errors">
                    <?php
            ...
            <div class="form-group">
                <textarea name="description" placeholder="Video Description" id="description" onmousemove="validateDescription()" class="form-control"  rows="4"><?= htmlentities($params['description']); ?></textarea>
